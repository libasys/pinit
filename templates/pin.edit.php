<div id="edit-pin" data-id="<?php p($_['id']); ?>">
  ...
  <input type="hidden" name="plat" id="plat" value="<?php p($_['lat']); ?>" />
   ...
   <input type="hidden" name="tagsforsave" id="tagsforsave" value="<?php p($_['tags']); ?>" />
     ...
     <br style="clear:both;">   
     <input type="text" style="width:290px;" placeholder="<?php p($l -> t("Name")); ?>" value="<?php p($_['title']); ?>" maxlength="300" id="pname"  name="pname" />
	 	<textarea style="width:300px;min-height:100px;" placeholder="<?php p($l -> t("Description")); ?>" id="pdescr"  name="pdescr"><?php p($_['description']); ?></textarea>
	  	<input type="text" style="width:270px;"  placeholder="<?php p($l -> t("Street, Postalcode, City, Country")); ?>" value="<?php p($_['location']); ?>"  id="plocation"  name="plocation" />
	  ...
	  <input style="width:270px;" type="text" placeholder="<?php p($l -> t("http://Url")); ?>" value="<?php p($_['url']); ?>" maxlength="300" id="purl"  name="purl" />
